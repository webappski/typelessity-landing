...
export const EN: TranslationMap = {
  ...
  'seo.home.description': 'AI booking widget that replaces forms with chat. 25+ languages, voice input, 150+ industries. Single-call extraction, GDPR-native, live in 1–2 days.',
