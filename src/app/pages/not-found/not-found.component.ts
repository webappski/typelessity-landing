    ...
    <section class="vc-wrap nf">
      ...
      <div class="nf__inner">
        ...
        <div class="nf__actions">
          <a class="vc-btn vc-btn-primary vc-btn-lg" [routerLink]="'/' + lang">Go home</a>
          <a class="vc-btn vc-btn-ghost vc-btn-lg" [routerLink]="'/' + lang + '/industries'">Browse industries</a>
          <a class="vc-btn vc-btn-ghost vc-btn-lg" [routerLink]="'/' + lang + '/blog'">Blog</a>
        </div>
      </div>
    </section>
  `,
